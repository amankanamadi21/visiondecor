...
budget levels — and reports budget-compliance rate and mean style-match
score. Uses the real database (real catalog, real design_principles), not
mocks, so the numbers reflect the actual seeded catalog's coverage.
